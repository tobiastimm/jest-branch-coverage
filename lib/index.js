...
const jestBranchCoverage = (branchName, origin) =>
  findAncestor(branchName, origin)
    .chain((ancestor) => changedFiles(branchName, ancestor))
    .chain(findRelatedTests)
    .chain(collectCoverageFromChanges)
    .run()
    .promise()
